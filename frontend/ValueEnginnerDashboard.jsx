...
function ValueEngineerDashboard() {
  const [data, setData] = useState([]);
  const [selectedRole, setSelectedRole] = useState('ValueEngineer');
  ...
  const fetchData = async (role) => {
    ...
    try {
      ...
      setData(prev => [...prev, ...combined]); // append data
    } catch (error) {
...
export default ValueEngineerDashboard;
